  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = useCallback(
    async (event) => {
      ...
      const text = usingProvider
        ...
        : ((formData: FormData) => (formData.get("message") as string) || "")(
            new FormData(form),
          );
  ...
  const inner = (
    <>
      ...
      <form
        ...
        {...props}
      >
        <InputGroup className="min-h-24 min-w-0 w-full items-stretch">
          {children}
        </InputGroup>
      </form>
    </>
...
export const PromptInputTextarea = ({
  ...
  return (
    <InputGroupTextarea
      className={cn(
        "field-sizing-content min-h-24 min-w-0 w-full max-h-48 py-2.5",
        className,
      )}
      name="message"
...
export const PromptInputFooter = ({
  ...
  <InputGroupAddon
    align="inline-end"
    className={cn("justify-end gap-1 shrink-0", className)}
    {...props}
  />
);
